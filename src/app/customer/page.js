                ...
                <div className=" bg-gray-100 ">
                    ...
                    <div className="bg-white w-full max-w-8xl rounded-2xl shadow-lg p-2 mt-1 mb-5">
                        <div className=" my-1.5">
                            <p><Link href="/dashboard" className="mx-3 text-xl text-gray-400 hover:text-indigo-600"><i className="bi bi-house"></i></Link>
                                ...
                                <i className="bi bi-chevron-right"></i>
                                <Link href="/customer" className="mx-3 text-md text-gray-700 hover:text-indigo-600">Add Customer</Link>
                            </p>
                        </div>
                    </div>
                    <form onSubmit={handleSubmit} className="p-2 w-7xl mx-auto">
                        ...
                        <div className="flex mb-4">
                            <button type="button" onClick={() => setActiveTab("customer")} className={`px-4 py-2 font-medium ${activeTab === "customer" ? "text-blue-900 border-b-2 border-blue-600" : "text-gray-600"}`}>
                                Personal Information
                            </button>
                            <button type="button" onClick={() => setActiveTab("contact")} className={`px-4 py-2 font-medium ${activeTab === "contact" ? "text-blue-900 border-b-2 border-blue-600" : "text-gray-600"}`}>
                                Contact Details
                            </button>
                        </div>
                            ...
                            <div className="bg-white shadow rounded-2xl p-6">
                                ...
                                <div className="grid grid-cols-3 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input name="company_name" value={formData.company_name} onChange={handleChange} placeholder="Enter Company name" className="w-full border rounded p-2" />
