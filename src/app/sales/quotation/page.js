                ...
                {totalPages > 1 && (
                  <div className="flex items-center justify-between px-6 py-3 border-gray-200 bg-white rounded-b-lg">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium rounded-md border bg-orange-500 text-white hover:bg-orange-600 disabled:opacity-50"
                    >
                      Next
                    </button>
                  </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-2.5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-emerald-600 text-lg">
                    ₹{" "}
                    {selectedPIQuotation.grand_total
                      ? Number(selectedPIQuotation.grand_total).toLocaleString(
                          "en-IN",
                        )
                      : "0"}
                  </span>
                  ...
                  Number(piPercentage) <= 100 && (
                    <div className="mt-3 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 flex justify-between items-center">
                      ...
                      <span className="text-base font-bold text-emerald-700">
                        ₹{" "}
                        {(
                          (Number(selectedPIQuotation.grand_total) *
                            Number(piPercentage)) /
                          100
